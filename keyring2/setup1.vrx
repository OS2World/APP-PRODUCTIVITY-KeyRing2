...
DefaultFieldName_Click: 
    ...
    PARSE VAR Alldata.s E "þ" Flag "þ" Curhint
    SELECT
        WHEN Flag = "I" THEN DO
            Value = VLSMsg(99)
        END
...
Editcolname: PROCEDURE
    ...
    PARSE VAR Alldata.s E "þ" Flag "þ" Curhint "þ" CurSlide
    ...
    IF Id = 1 THEN DO
        ...
        IF Id = 1 THEN DO
            PARSE VAR Alldata.s E "þ" Flag "þ" Oldhint "þ" OldSlide
            Alldata.s = E || "þ" || Flag || "þ" || Curhint "þ" OldSlide
        END
...
/*
        if Aprompt <> "" THEN DO
            ...
            IF Id = 1 THEN DO
                PARSE VAR Alldata.s E "þ" Flag "þ" Oldhint "þ" OldSlide
                Alldata.s = E || "þ" || Flag || "þ" || Oldhint || "þ" || CurSlide
            END
        end;
*/
...
Hideclick:
    ...
    PARSE VAR Alldata.s Enb "þ" Flag
    IF Enb <> 1 THEN DO
        Enb = 1
    END
        ELSE DO
...
Init:
    ...
    DO I = 1 TO 6
        ...
        DO J = 1 TO 9
            ...
            PARSE VAR Colenb Enb "þ" Flag "þ" Hint "þ" Abbrev
            Columndata.j = Colenb
    ...
    DO I = 1 TO 6
        ...
        DO J = 1 TO 9
            ...
            IF SUBSTR(Colnames.j, 1,1) = "+" THEN DO
                Enb = 1
            END
            PARSE VAR Coldata.j E "þ" Flag "þ" Hint "þ" Abbrev
...
Usedefaultsbutton_click: PROCEDURE EXPOSE Contnames. Defflgs.
    ...
    IF Id = 1 THEN DO
        DO I = 1 TO 6
            ...
            DO J = 1 TO 9
                /* get the old flag */
                PARSE VAR Columndata.j Enb "þ" Flg "þ" H "þ" A
