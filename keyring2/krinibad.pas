...
CONST
    ...
    FunctionTable  : ARRAY[0..2] OF PCHAR
    = ('KRILoadFuncs',
       'KRGetCryptType',
       'KRDropFuncs');
...
VAR
    ...
    {returns:
        0                                = alldone
        3þasdfþveryþlongþformattedþstring" = pgnumber plus expired record fields
    }
...
{$ENDIF}
    ...
    FUNCTION KRGetPageOrdEnb(Name           : PCHAR; { FUNCTION KRGetPageOrdEnb(PgNum : WORD) : STRING "0þU" }
                             ArgC           : ULONG;
                             Args           : pRxString;
                             QueueName      : PCHAR;
                             VAR Ret        : RxString) : ULONG; {$IFDEF DLL}EXPORT;{$ENDIF}
    ...
    FUNCTION KRGetColumnEnable(Name           : PCHAR; { FUNCTION KRGetColumnEnable(PgNum, FldNum : WORD) : STRING "0þUþurlhinthinthintþabbrev" }
                               ArgC           : ULONG;
                               Args           : pRxString;
                               QueueName      : PCHAR;
                               VAR Ret        : RxString) : ULONG; {$IFDEF DLL}EXPORT;{$ENDIF}
